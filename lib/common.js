...
var getNearestNodeModulePath = function (basedir) {
    ...
    } while (home !== nodeModulePath && newPath !== nodeModulePath);       //we can not go beyond home directory for user if we reach top of tree in directory structure then break this loop
    return undefined;
};
